      ...
      <Container className="" style={{ padding: "20%" }}>
        <Container className="d-flex flex-column justify-content-center align-content-center align-items-center">
          <Form>
            ...
            <h4>
              Te hemos enviado un email a tu dirección de correo electrónico.
              Contiene un enlace que te permitirá confirmar tu cuenta. Si no lo
              encuentras, recuerda revisar en la carpeta de correo no
              deseado/spam.
            </h4>
          </Form>
        </Container>
