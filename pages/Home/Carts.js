...
import {BsShieldCheck, BsCreditCard, BsFillPersonCheckFill} from "react-icons/bs"
...
export default function Carts() {
    return (
        ...
        fluid className='mt-5 pb-5 d-flex flex-column justify-content-center align-items-baseline'>
            <Row className='pt-5 mx-5 d-flex justify-content-center'>


                <h1 className='d-flex justify-content-center'>¿Por qué comprar con nosotros?</h1>

                <Row className='d-flex justify-content-center py-3' >
                    <Card style={{ width: '17rem', height: '10rem'}} className="mx-3 my-3">
                    ...
                    <div className='d-flex justify-content-center align-items-center' style={{width: "100%", flexDirection: "column"}} >
                        <div>
                        <Button variant="primary" className='d-inline' style={{width: "auto"}} >Encuentra una bici para ti</Button>
                        </div>
                        <br/>
                        <div>
