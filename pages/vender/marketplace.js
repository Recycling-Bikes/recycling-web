        ...
        <Col className="mx-4 px-2 d-flex flex-column justify-content-center align-items-baseline">
          ...
          >
            ...
            <Row sm="auto">
              ...
              <Col className="p-2 d-flex flex-column text-secondary" lg={5}>
                Nos aseguramos de que la venta sea segura y que recibas tu
                dinero.
              </Col>
            </Row>
            ...
            <Row sm="auto">
              ...
              <Col className="p-2 d-flex flex-column text-secondary" lg={5}>
                Realizamos el envío con un distribuidor de confianza.
              </Col>
            </Row>
            ...
            <Row sm="auto">
              ...
              <Col className="p-2 d-flex flex-column text-secondary" lg={5}>
                Brindamos soporte, antes, durante y luego de que recibas tu
                bici.
              </Col>
            </Row>
          </div>
