        ...
        Trade - in
          ...
          <Accordion className="mt-3 separador" defaultActiveKey="0" flush>
            ...
            <Link href="#">
              ...
              Recycling Certified - 12 meses</Link>
                      <p className="mt-2">
                          Esta bicicleta ha sido inspeccionada y certificada por
                          nuestros expertos mecánicos.
                          <br />
                          <br />
                          Nuestro servicio de guante blanco incluye una puesta a
                          punto de transmisión, frenos y dirección. Los
                          consumibles desgastados como cadena, pastillas de
                          freno, cubiertas o cableado son reemplazados por otros
                          nuevos si han llegado al final de su vida útil
            </p>
