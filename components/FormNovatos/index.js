import FormNovatosComponent, { Selects } from "components/FormNovatos/component";
  ...
  return (
    <FormNovatosComponent>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        {progress? <ProgressBar className="mt-5" now={progress} />: null}
        <div className="mb-4"/>
        <h1 className="mb-5" style={{ color: "#212928" }}>
          {title}
        </h1>
        <h3 className="mb-3" style={{ color: "#212928" }}>{description}</h3>
        ...
        <Button variant="" onClick={()=> router.push(back)} style={{color: "#0FA899"}} > <MdKeyboardArrowLeft/> Atrás</Button>
